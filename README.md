...
<p align="center">Скрипт-виджет Tampermonkey для тех, кто работает с большим количеством однотипных задач в течение дня.</p>
<p align="center">Он считает, сколько должно быть сделано и к какому времени.</p>

<p align="center">По умолчанию настроен для одного сайта,</p>
