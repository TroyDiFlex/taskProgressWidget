...
<p align="center">По умолчанию настроен для одного сайта, 
  но в коде можно легко изменить адрес (строка 7: // @match *://любойСайт.com/*)
</p>
<p align="center">Но в коде можно легко изменить адрес (строка 7: // @match *://любойСайт.com/*).</p>
